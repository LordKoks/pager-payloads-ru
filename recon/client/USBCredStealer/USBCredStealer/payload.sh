...
log_action() {
    ...
    echo "Разработано: bad-antics" >> "$LOG_FILE"
    echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━" >> "$LOG_FILE"
}
...
$wifiData = "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━`nNullSec WiFi Password Harvester`nРазработано: bad-antics`n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━`n"
...
echo "Разработано: bad-antics" >> "$OUTDIR/wifi_passwords.txt"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━" >> "$OUTDIR/wifi_passwords.txt"

# СетьManager
for conn in /etc/СетьManager/system-connections/*; do
    if [ -f "$conn" ]; then
