...
# Title: Портал Дефейса NullSec
# Author: bad-antics
# Description: Страница дефейса в стиле хакера с захватом учетных данных
...
PROMPT "ПОРТАЛ ДЕФЕЙСА NULLSEC

Страница дефейса в стиле
хакера с анимированными эффектами.

Показывает 'ВЗЛОМАНО NULLSEC'
затем захватывает учетные данные.

Создано bad-antics

Нажмите ОК для настройки."

SSID=$(TEXT_PICKER "SSID ТД:" "Free_Public_WiFi")
DURATION=$(NUMBER_PICKER "Длительность (мин):" 30)
DURATION_SEC=$((DURATION * 60))

CRED_LOG="$LOOT_DIR/deface_$(date +%Y%m%d_%H%M).txt"

resp=$(CONFIRMATION_DIALOG "ЗАПУСТИТЬ ПОРТАЛ ДЕФЕЙСА?

SSID: $SSID
Длительность: ${DURATION} мин

Нажмите ОК для развертывания.")
...
<div class="container">
    ...
    <div class="message-box">
        ...
        <p>> Весь сетевой трафик контролируется</p>
    ...
    <div class="login-box">
        <h3>⚠️ СЕТЬ AUTHENTICATION REQUIRED</h3>
...
<p>Сеть connection reestablished.</p>
...
LOG "Запуск Портала Дефейса NullSec..."
