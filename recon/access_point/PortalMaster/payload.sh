...
# Title: Portal Master
# Author: bad-antics
# Description: Универсальный генератор порталов с более чем 15 шаблонами
...
5. Финансовые
6. Технические/IT
7. Специальные NullSec

Выберите категорию." 

CATEGORY=$(NUMBER_PICKER "Категория (1-7):" 1)
...
5. TikTok
6. Snapchat"
        TEMPLATE=$(NUMBER_PICKER "Шаблон (1-6):" 1)
        case $TEMPLATE in
...
6. Captive Survey"
        ...
        case $TEMPLATE in
            ...
            3) PORTAL_NAME="Police"; DEFAULT_SSID="Guest_Сеть" ;;
