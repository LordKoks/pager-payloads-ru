...
DEAUTH_REAL=$(CONFIRMATION_DIALOG "Отключить реальную ТД?
...
resp=$(CONFIRMATION_DIALOG "ЗАПУСТИТЬ EVIL TWIN?
...
<div class="container">
<h1>📶 $TARGET_SSID</h1>
<div class="warning">⚠️ Сессия истекла. Пожалуйста, введите пароль WiFi снова.</div>
...
LOG "Evil Twin активен: $TARGET_SSID"
...
PROMPT "АТАКА EVIL TWIN ЗАВЕРШЕНА
