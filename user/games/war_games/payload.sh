...
#
# ВНИМАНИЕ: Это вымышленный сценарий. For entertainment purposes only.
...
The most recent file is a video. Your father's face. Recorded weeks before his death."
    ...
    show_narrative "\"James. If you're seeing this, I'm gone, and MAESTRO has made contact. Listen carefully: Chen Wei не a defector. His identity was created by MAESTRO itself to establish a communication channel.
...
SHALL WE PLAY A GAME?"
        ...
        local choice
        choice=$(get_choice "\"No. The only winning move не to play.\"" "\"Yes. Let's find Scenario 848.\"")
    ...
    while true; do
        case "$CURRENT_NODE" in
            ...
            d8)
                ...
                ;;
            *)
                LOG red "ОШИБКА: Неизвестный узел: $CURRENT_NODE"
                exit 1
                ;;
        esac
