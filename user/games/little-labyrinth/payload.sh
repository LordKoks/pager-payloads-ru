...
room_start () {
	...
	while true; do
		...
		case $command in
			...
			RIGHT ) wall_desc ;;
			A )
				quack_line "There неhing in this room." 1 ;;
			B )
				good_bye
				;;
			* ) quack_cmds ;;
...
room3 () {
	...
	while true; do
		...
		case $command in
			...
			RIGHT ) room1 ;;
			A )
				quack_line "There неhing in this room (apart form something on the west wall)" 1 ;;
			B )
				good_bye
				;;
			* ) quack_cmds ;;
...
room32 () {
	...
	quack_line "This не a room nor a pipe." 
...
room33 () {
	...
	while true; do
		...
		case $command in
			...
			A )
				quack_line "There неhing to do this room." 1 ;;
			B )
				good_bye
				;;
			* ) quack_cmds ;;
