...
normalize_subnet() {
    ...
    if [ $prefix -ge 24 ]; then
        # Сеть bits cover first 3 octets completely, partial 4th octet
        ...
        # Сеть bits cover first 2 octets completely, partial 3rd octet
        ...
        # Сеть bits cover first octet completely, partial 2nd octet
        ...
        # Сеть bits are partial in first octet
