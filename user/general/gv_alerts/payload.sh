...
install_payload() {
    ...
    ALERT "GV Alerts установлен! Checking every $CHECK_INTERVAL min. Edit payload.sh to change."
}
...
uninstall_payload() {
    ...
    LOG green "Unустановлен!"
    ALERT "GV Alerts unустановлен"
}

toggle_alerts() {
    if is_установлен; then
